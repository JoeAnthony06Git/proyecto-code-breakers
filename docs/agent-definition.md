...
- `skillRetrieveApprovedKnowledge`: recupera solo contenido aprobado de Futuro Academy y devuelve fuentes.
...
- El usuario nunca debe ver score, prioridad, breakdown, B2B/B2C ni rationale interno.
